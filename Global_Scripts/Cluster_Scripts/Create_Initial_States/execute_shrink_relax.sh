...
do
	...
	nohup bash shrink_relax.sh ${numberOfMonomers} ${architecture} ${run} ${angle1} ${angle2} ${seeds[$[$run-1]]} ${special_simulation} > ../${folderPrefix}${architecture}/run${run}/nohup.out & # running in the background
