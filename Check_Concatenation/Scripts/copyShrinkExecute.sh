...
CHECK_CONCATENATION=/Check_Concatenation/
...
if ! [ -z ${special_simulation} ]; then
	mkdir -p b${numberOfMonomers}/${special_simulation}/${architecture}/run${runIndex}
        folderPrefix=b${numberOfMonomers}/${special_simulation}/ # The folder where the architecture directories reside
